...
void AdvancedTechnologyAttachment::Identify()
{
    ...
    // first flag means device busy, second means device error. we wait until device is ready with this loop
...
void AdvancedTechnologyAttachment::Read28(uint32_t sector, uint8_t* data, int count)
{
    ...
    if (count > bytesPerSector)
        return; // refuse writing too much to one sector
